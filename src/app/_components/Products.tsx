                    ...
                    return (
                        <SwiperSlide key={p.id}>
                            <Link aria-label='Acessar página do produto' href={`/produto/${p.id}`} className='' >
                                ...
                                <h1 className='text-[2rem] mt-[1.2rem] text-zinc-900 dark:text-zinc-100 font-semibold'>{p.name}</h1>
                                <div className='flex items-center gap-[.3rem] mt-[.2rem] mb-[.6rem] '>
                                    <Star className='dark:fill-zinc-100 size-[1.8rem]' />
                                ...
                                <span className='text-[1.6rem] font-semibold  block text-zinc-800 dark:text-zinc-200'>
                                    R$ {p.price.toFixed(2)}
                                </span>
