                ...
                {!hasTwoStepsAuth && <div className=''>
                    ...
                    <form onSubmit={handleSubmit(signIn)} className='w-full lg:w-[80%] mt-[1.2rem] flex flex-col gap-[1.2rem]'>
                        ...
                        <div className="flex gap-[1rem]">
                            <Link href={`${process.env.NEXT_PUBLIC_API_PROD_URL}/auth/google`} className='bg-zinc-100 text-zinc-900 flex-1  p-[1rem] font-semibold text-[1.5rem] rounded-[.5rem] disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-[1rem] justify-center'>
                            ...
                            <Link href={`${process.env.NEXT_PUBLIC_API_PROD_URL}/auth/github`} className='bg-zinc-100 text-zinc-900 flex-1  p-[1rem] font-semibold text-[1.5rem] rounded-[.5rem] disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-[1rem] justify-center'>
